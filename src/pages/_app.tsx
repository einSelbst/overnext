...
const IconLink = ({
  ...
  return <link rel={rel} sizes={`${size}x${size}`} href={href} />
}

const IconLinkApple = ({ size }: { size: string }): JSX.Element => {
  return (
    <IconLink
...
const HeadIcons = (): JSX.Element => {
  ...
  return (
    <Head>
      ...
      />
      <IconLinkApple size='57' />
      <IconLinkApple size='72' />
      <IconLinkApple size='76' />
      <IconLinkApple size='114' />
      <IconLinkApple size='120' />
      <IconLinkApple size='144' />
      <IconLinkApple size='152' />
      <link
        rel='apple-touch-icon'
        sizes='180x180'
